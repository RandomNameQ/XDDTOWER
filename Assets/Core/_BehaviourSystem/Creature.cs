...
public class Creature : MonoBehaviour
{
    ...
    [Button]
    public void TransferDataToEventBehaviour()
    {
    ...
    {
        foreach (BehaviorRule rule in behavior.currentRang.rules)
        {
            // EventControllerBehaviour.Instance.AddRequest(this, rule.request);
        }
    }
